...
#         humanoid_shm_names=self.proxy.get_available_components('m3humanoid_shm')
#         print("gmwkrmlkhnwrllwrnrww")
#         print(humanoid_shm_names)
#         if len(humanoid_shm_names) > 0:
           
#             try:
#                 self.proxy.make_safe_operational(humanoid_shm_names[0])
#                 print(" inciou bbbbbbbbbbbbbbbbbbbbbbbbb")
#             except:
#                 print("nao inciou aaaaaaaaaaaaaaaaaaaa")

#                                                                                                 # [angulacao altura braco pelo ombro, abertura braco, giro do braco -26.0, 8.0, cotovelo, angulo mao, -36.0, -2.0]
#         #self.poses={'holdup':{'right_arm':[15.0, 26.0, -8.0, 84.0, 119.0, -36.0, 2.0],'left_arm':[56.0, -26.0, 8.0, 84.0, -119.0, -36.0, -2.0]}} 
#         self.poses={'holdup':{'right_arm':[15.0, 26.0, -8.0, 84.0, 119.0, -36.0, 2.0],'left_arm':[20, 0.0, 0.0, 100.0, -120.0, -36.0, -2.0]}} 
#         self.poses['holdup1']={'right_arm':[15.0, 26.0, -8.0, 84.0, 119.0, -36.0, 2.0],'left_arm':[50, 0.0, 0.0, 50.0, -120.0, -36.0, -2.0]}
...
# #        self.bot.set_mode_off(self.hand_name)q
#         self.bot.set_stiffness(self.hand_name,[self.handStiffness/100.0]*3,[2,3,4])
#         self.bot.set_slew_rate_proportion(self.hand_name,[10.0]*3,[2,3,4])
#         self.bot.set_mode_torque_gc(self.hand_name,[2,3,4])
#         self.bot.set_torque(self.hand_name,self.handTorqCoeff[1:]*350,[2,3,4])
#         self.bot.set_mode_theta_gc(self.hand_name,[0,1,2,3,4])
#         self.bot.set_theta_deg(self.hand_name,[00,00,00,00,00.0],[0,1,2,3,4])
#         #self.bot.set_theta_deg(self.hand_name,[300,300,300,300,300.0],[0,1,2,3,4])
...
#     def step_hold_up1(self):
#         self.bot.set_mode_theta_gc(self.arm_name)

#         self.bot.set_theta_deg(self.arm_name,self.poses['holdup1'][self.arm_name])
#         self.bot.set_stiffness(self.arm_name,[self.stiffness/100.0]*self.ndof)
#         self.bot.set_slew_rate_proportion(self.arm_name,[1.0]*self.ndof)
#         #self.bot.set_thetadot_deg(self.arm_name,[15.0]*self.ndof)
